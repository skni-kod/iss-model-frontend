...
import MissionBadge from "../components/astronauts/MissionBadge";
import { Badge } from "../components/ui/badge";
import { CalendarIcon, RocketIcon } from "lucide-react";
import { getPeopleInSpace, type PeopleInSpaceResponse } from "../lib/api/astronauts";
import { getMissionInfo } from "../lib/api/missionPatches";
          ...
          {Object.entries(groupedAstronauts).map(([spacecraft, astronauts]) => (
            <section key={spacecraft} className="@container space-y-6">
              ...
              <MissionBadge
                ...
                missionInfo={getMissionInfo(spacecraft)}
              ...
              <div className="flex items-center gap-4">
                <h3 className="text-lg font-semibold flex items-center gap-2 text-gray-300">
                  <RocketIcon className="w-4 h-4 text-gray-400" />
                  Załoga
                </h3>
