...
function HeroTitle() {
  return (
    <motion.div className="space-y-6 sm:space-y-8" variants={heroItemVariants}>
      {/* Main Heading */}
      <motion.div className="space-y-6" variants={heroTitleVariants}>
        ...
        >
          ...
          <span className="block text-lg sm:text-2xl lg:text-3xl font-normal text-gray-400 mt-3 sm:mt-4">
