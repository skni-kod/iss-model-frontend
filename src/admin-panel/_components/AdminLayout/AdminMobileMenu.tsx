...
const AdminMobileMenu = ({
  ...
  return (
    <>
      {/* Mobile Menu Overlay */}
      <div
        className={`lg:hidden fixed inset-0 z-50 bg-black transition-opacity duration-300 ${isOpen
      ...
      {/* Mobile Menu Sidebar */}
      <div
        className={`lg:hidden fixed left-0 top-0 bottom-0 w-64 bg-white shadow-xl z-50 transform transition-transform duration-300 ease-out ${isOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
